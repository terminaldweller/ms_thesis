...
x = x.sample(frac=0.009)
y = y.sample(frac=0.009)
...
def main() -> None:
    ...
    plt.savefig(f"/opt/app/data/adv_count_GAN_02_3.png")
    plt.show()
    plt.close()
    ...
    plt.savefig(f"/opt/app/data/adv_count_GAN_05_3.png")
    plt.show()
    plt.close()
    ...
    plt.savefig(f"/opt/app/data/adv_count_GAN_1_3.png")
    plt.show()
    plt.close()
    ...
    plt.savefig(f"/opt/app/data/adv_count_GAN_2_3.png")
    plt.show()
    plt.close()
